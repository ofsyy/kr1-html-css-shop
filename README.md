...
ФИО: Бурый Александр Евгеньевич 
Группа: ЭФБО-14-25 ИРИТ
## Текущий статус

Создана базовая структура проекта.
## Ссылка на опубликованный проект

GitHub Pages: https://ofsyy.github.io/kr1-html-css-shop/
...
- добавлены изображения, изменены названия, добавлена цена и описание товара
